...
insert  into `sw_order_base`(`id`,`order_no`,`order_date`,`pay_way`,`good_date`,`finish_date`,`order_type`,`sale_type`,`order_status`,`memo`,`cust_comp_no`,`cust_comp_name`,`cust_contact_name`,`cust_mobile`,`cust_phone`,`cust_tax`,`cust_addr`,`supply_comp_no`,`supply_comp_name`,`supply_contact_name`,`supply_mobile`,`supply_phone`,`supply_tax`,`supply_addr`,`create_no`,`create_time`,`modi_no`,`modi_time`,`version`) values (1,'D-20171219164234-01474','2017-12-19','TEL_PAY','2017-12-01','2017-12-19','SIMPLE_ORDER','INNER_SALE','AUDIT01_SUCCESS',NULL,'BJHY','北京好友科技','北京好友科技','0631-5769674','0631-5769674','0631-5769674','北京市中关村5号',NULL,'山东思维纺织','王芳芳','15166119377','0631-5769674','0631-5769674','山东省威海市环翠区羊亭裕林工业园5号','wangfangfang','2017-12-19 16:42:35','wangfangfang','2017-12-19 16:43:00',NULL);
...
insert  into `sw_purchase_base`(`id`,`pur_no`,`pur_date`,`expect_date`,`resp_name`,`supply_comp_no`,`supply_comp_name`,`supply_contact_name`,`supply_mobile`,`supply_phone`,`supply_tax`,`supply_addr`,`pur_amt`,`pur_num`,`pur_status`,`memo`,`create_no`,`create_time`,`modi_no`,`modi_time`,`version`) values (1,'C-20171219170945-37496','2017-12-19','2017-12-19','dssd','BJHY','北京好友科技','北京好友科技','0631-5769674','0631-5769674','0631-5769674','北京市中关村5号','0.00','33.00','WAIT_AUDIT',NULL,'wangfangfang','2017-12-19 17:09:46','wangfangfang','2017-12-19 17:10:00',0);
...
insert  into `sw_purchase_detail`(`id`,`pur_no`,`pur_seq_no`,`order_no`,`order_seq_no`,`material_no`,`material_name`,`material_type`,`material_long`,`material_width`,`spec`,`pattern`,`unit`,`num`,`price`,`amt`,`memo`,`create_no`,`create_time`,`modi_no`,`modi_time`,`version`) values (1,'C-20171219170945-37496','1',NULL,NULL,'TBYD1','台布','PROD','3.00','3.00',NULL,NULL,NULL,'33.00',NULL,'0.00','333','wangfangfang','2017-12-19 17:09:46','wangfangfang','2017-12-19 17:09:46',0);
...
insert  into `sw_receive_base`(`id`,`recv_no`,`recv_date`,`recver`,`recv_status`,`use_way`,`num`,`memo`,`create_no`,`create_time`,`modi_no`,`modi_time`,`version`) values (1,'R-20171219152845-99204','2017-12-19','张三','AUDIT_SUCCESS','织布','33645.00','aaaaaa','wangfangfang','2017-12-19 15:28:46','wangfangfang','2017-12-19 18:23:23',0),(2,'R-20171219175312-83969','2017-12-19','张三','WAIT_AUDIT','三生三世撒','333.00','是多少','admin','2017-12-19 17:53:13','wangfangfang','2017-12-19 18:28:47',0),(3,'R-20171219180532-26398','2017-12-19','sdsd','WAIT_APPLY','sd','67.00','sdsd','admin','2017-12-19 18:05:33','admin','2017-12-19 18:07:35',0);
...
insert  into `sw_receive_detail`(`id`,`recv_no`,`recv_seq_no`,`material_no`,`material_name`,`material_type`,`spec`,`pattern`,`unit`,`num`,`create_no`,`create_time`,`modi_no`,`modi_time`,`version`) values (2,'R-20171219152845-99204','1','TBYD1','台布','PROD','超棉文艺复兴','超棉文艺复兴','米','333.00','wangfangfang','2017-12-19 16:56:35','wangfangfang','2017-12-19 18:01:57',NULL),(3,'R-20171219152845-99204','2','TBYD5','圆底台布','PROD','超棉文艺复兴','超棉文艺复兴','米','33312.00','wangfangfang','2017-12-19 16:56:35','wangfangfang','2017-12-19 18:01:55',NULL),(4,'R-20171219175312-83969','1','TBYD1','台布','PROD','超棉文艺复兴','超棉文艺复兴','米','333.00','admin','2017-12-19 17:53:13','admin','2017-12-19 18:01:54',0),(6,'R-20171219180532-26398','1','TBYD1','台布','PROD','超棉文艺复兴','圆','米','23.00','admin','2017-12-19 18:07:37','admin','2017-12-19 18:07:37',NULL),(7,'R-20171219180532-26398','2','TBYD4','圆底台布','PROD','超棉文艺复兴','圆','米','44.00','admin','2017-12-19 18:07:37','admin','2017-12-19 18:07:37',NULL);
...
CREATE TABLE `sw_stock_info` (
  ...
  `version` int(11) DEFAULT '0' COMMENT '版本号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='库存表';

/*Data for the table `sw_stock_info` */

insert  into `sw_stock_info`(`id`,`material_no`,`num`,`modi_time`,`version`) values (61,'TBYD','123.00','2017-12-14 17:17:31',1),(62,'KBLT-DZ-54','45454.00','2017-12-14 17:17:31',1);
...
CREATE TABLE `sys_dict` (
  ...
  `memo` varchar(128) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COMMENT='数据字典';
