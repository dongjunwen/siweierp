 ...
 * @Description：
 **/
@ApiModel(value = "采购单审核Vo SwPurAuditVo")
public class SwPurAuditVo {
    /**
     * 审核单号
     */
    @ApiModelProperty(value = "采购单号列表",required =false )
    ...
    public PurStatus getPurStatus() {
        return purStatus;
    }

    public void setPurStatus(PurStatus purStatus) {
